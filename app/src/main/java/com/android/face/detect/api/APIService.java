 ...
 */
package com.android.face.detect.api;
...
import com.android.face.detect.api.model.DynamicParams;
import com.android.face.detect.api.model.FaceModel;
import com.android.face.detect.api.model.RegParams;
import com.android.face.detect.api.utils.DeviceUuidFactory;
import com.android.face.detect.api.utils.HttpUtil;
import com.android.face.detect.api.utils.LogUtil;
import com.android.face.detect.api.utils.OnResultListener;
import com.android.face.detect.api.utils.RegResultParser;
import com.android.face.detect.api.utils.UploadParser;
import com.android.face.detect.api.utils.UserListParser;
import com.android.face.detect.api.utils.VerifyParser;
...
//        params.putParam("deviceId", "DS-2CD5A32EFWD-IZ20170412AACH734237291");
        ...
        if (extraParams != null) {
            for (String p : extraParams.keySet()) {
                ...
                Log.e("xx","upload" + p + "=" + extraParams.get(p));
            }
        }
